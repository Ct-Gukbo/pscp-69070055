...
```text
https://ijudge.it.kmitl.ac.th/problems/3072/description
```
...
Output:
print a e i o u ว่ามีกี่ตัวถ้าไม่มีในตัวนั้นๆให้ไม่ปริ้น
...
```text
Step 1: เก็บค่าstr.lower()
Step 2: ไปเช็คว่ามีตัวไหนบ้าง
Step 3: เช็ค ว่า a e i o u มีกี่ตัว
Step 4: print a e i o u
```
...
```text
เหมือนวิธีเเรกเลยโดยการใช้list check
```

...
```https://ijudge.it.kmitl.ac.th/submissions/545070/overview
...
```text
ผมรับinputมาเเละคูณค่าหาprice_boriเลย เเละก็นำเข้าไปหา ราคาค่าบริการ เเล้วค่อยนำค่าบริการบวกกับเงินเพื่อบวกค่าหาภาษีเเละprintออกมา
```
...
```text
Step 1:ผมได้เขียนกรณีเป็นรวบเป็นกรณีเดียวกัน
Step 2:ผมเปลี่ยนวิธีเป็นเเยกกรณีเพื่อเช็คprice_bori
Step 3:เเละผมก็ทำเเยกกรณีเเละก็ทำให้มันเสร็จได้
```
...
```text
ทำกรณีเพิ่มขึ้นมาเพื่อหา50 กับ 1000 ในกรณีของค่าบริการ

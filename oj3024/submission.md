...
```text
https://ijudge.it.kmitl.ac.th/submissions/566403/overview
```
...
Output:
เป็นได้2 อย่าง ถ้าหาค่าในfunctionถ้าเป็น - จะได้เป็น0เเทน เเละเข้าไปเช็คด้่านล่าง
Surprising 
Not Surprising

Constraints:
allscore highest เเละ 
```
...
```text
Step 1: รับค่า allscore & highest
Step 2: check กรณีโดยการหาร2 เเละลบ
Step 3: Checkว่ามากกว่า2ไหม
Step 4: print answer
...
```text
มาหากรณีที่พลาดไปคือติดลบเลยมาใช้เปลี่ยนการเช็คเป็นหารค่าสูงสุดเเทนถ้าน้อยกว่าศูนย์
```
...
```text
หากรณีที่หาไม่เจอเเละดูกรณีเช็คที่หาไม่เจอ
```

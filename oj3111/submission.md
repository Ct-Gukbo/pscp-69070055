...
```text
https://ijudge.it.kmitl.ac.th/submissions/629300/overview
```
...
```text
โจทย์ให้หายอดสุทธิหลังหักส่วนลด

Input:
รับpass(str) รับจำนวนรอบ n เเละรับในลูบรอบ n

Output:
พิมพ์เลขที่ผ่านการคำนวณเเล้วเป็น ทศนิยม2 ตำเเหน่ง

Constraints:
รับเป็นint ออกเป็นfloat เเละ มีstr
```
...
```text
Step 1: ให้ทศนิยม=0ก่อนในtotal price
Step 2: คิดราคารวมก่อน
Step 3: เข้ากรณี Y หรือ N
Step 4: หาทศนิยม2ตำเเหน่งเเละปัดขึ้นเเล้วจึงปริ้น
```
...
```text
เเผนเเรกผมอาจจะต่างออกไปเป็นการคิดเลขตรงๆเเต่เเผนสุดท้ายผมใช้เป็นfrom decimal เเทน
```

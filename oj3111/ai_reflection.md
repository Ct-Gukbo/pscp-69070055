...
```text
i use ai by check the test case and find a way to round up best
```
...
```text
basic logic and every thing i do it but the extension that i use is a round up and decimal one
```
...
```text
i check test case and i know the extension that use to round up the decimal
```

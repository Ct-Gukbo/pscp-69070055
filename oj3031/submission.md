...
```text
https://ijudge.it.kmitl.ac.th/submissions/602183/overview
```
...
```text
โจทย์ให้อ่านจำนวนเต็มหนึ่งตัว แล้วตัดสินว่าเป็นเลขคู่หรือเลขคี่

Input:
รับค่าคู่ 2 ตัว

Output:
หา ค่าที่กระจาย เเละใช้math.ceilปัดขึ้น

Constraints:
ค่าที่รับมาเป็นint เเละ คู่ 2 ตัว
```
...
```text
Step 1: อ่านจำนวนเต็ม n ตัวที่ 1 เเละ 2
Step 2: นำไปคิดค่ากระจายต่อวิ
Step 3: ปริ้นค่าคำตอบออกมา
Step 4: ใช่math.ceilปัดค่าขึ้น
...
```text
ดูเเนวทางในการทำโจทย์
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนlogicด้วยตัวเอง
```

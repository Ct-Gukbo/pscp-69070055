...
```https://ijudge.it.kmitl.ac.th/submissions/541721/overview
...
```ผมได้รับค่าที่เป็นชื่ออะไรก็ได้เข้ามาเพื่อเเปลงการปริ้นโดยการที่ใช้stepเป็น -1 เเละทำให้เเปลงกลับมาจากหลังสุดมาหน้าสุดเเละใช้.lower()เพื่อทำให้เป็นตัวพิมพ์เล็กทั้งหมด
...
```text
Step 1:ตอนเเรกเขียนinputเเละ.lower()เเล้ว
Step 2:คิดไม่ค่อยออกหาเเนวทางจากgoogle
Step 3:เจอเเนวทางว่าใช้[::-1]ได้เลยนำมาใช้
```
...
```สุดท้ายผมก็ได้ใช้[::-1]มาเป็นcoreที่ทำให้โปรเเกรมนี้สามารถรันได้ตามโจทย์
...
```เพราะมีการใช้ตัวเลขเข้ามาเกี่ยวข้อง
...
```test สำหรับหลายๆsymbolกับเลขรวมกัน
...
ตัวอย่างที่อนุญาต: ถามว่าจะทำให้กลับหลังยังไงเเละไปหาข้อมูลในgoogleกับเพื่อนที่เป็นpairของผม
...
```เขียนinputเเละหาข้อมูลวิธีการทำ

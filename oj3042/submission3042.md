...
```text
ผมเข้าใจว่าโจทย์ต้องการให้หาเลขที่อยู่ในฐาน 10 ไปจนถึง 0

Input:
จำนวนเต็มหนึ่งค่า n

Output:
n - 10 --> 0 โดยที่เริ่มจากฐาน 10

Constraints:
input เป็นจำนวนเต็ม เเละ หาค่าที่เป็นเลขฐาน 10 ใน ans
```
...
```text
Step 1: หาเลขที่โดน -10 มาเรื่อยเเละprint มันออกมา
Step 2: ใช้ % เพื่อ หาเลขฐาน10 
Step 3: ให้print เพิ่มเป็นend=" "
Step 4: ปิดfunction
```
...
```text
ใช้การหาเลขฐาน10เเล้วนำเลขนั้นมาเข้าในwhileloop
```
...
```text
เพราะมันสามารถเช็คได้ว่ารันsmoothไหม
```

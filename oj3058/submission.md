...
```text
https://ijudge.it.kmitl.ac.th/submissions/608427/overview
```
...
```text
รับค่าอิฐใหญ่อิฐเล็กเเละจุดหมาย เเละคำนวนจำนวนอิฐที่น้อยที่สุด
Input:
รับค่าอิฐใหญ่อิฐเล็กเเละจุดหมาย

Output:
จำนวนอิฐที่น้อยที่สุด

Constraints:
input เป็น จำนวนเต็มบวก 3 จำนวน จำนวนอิฐก้อนเล็กที่ต้องใช้ ถ้าไม่สามารถสร้างได้ ตอบ -1
```
...
```text
Step 1: รับค่าsmallbrick bbrick goal
Step 2: หาbig
Step 3: หาอันที่ใช้อันใหญ่สุดก่อน
Step 4: หาเลขสุดท้าย
```
...
```text
ใช้วิธีนี้เเต่ว่าเขียนวิธีผิดตั้งเเต่เเรก
```

...
| OJ submission ID, if submitted | 543902 |
| OJ status | Pass |
...
```i just use an AI to check my hidden test case that what i could have miss
...
```
    i ask AI check the hidden tests case that i could have miss
---
...
```
    make me notice that i forgot to use the same color function
---
...
```
    i check that i could have miss something like the sylable mistake but i couldn't think of some test case that i miss so i use AI to help me think
```
...
```
i just use the ai to help some test case that i forget 
---

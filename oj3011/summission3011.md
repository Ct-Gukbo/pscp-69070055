...
```https://ijudge.it.kmitl.ac.th/submissions/543902/overview
...
```ผมได้รับค่าสีสองสีให้มาเทียบกันเเล้วให้print output ตามcaseไป เเละถ้าสีไม่ตรงcaseก็จะไปเป็นelse ให้printเป็นERROR
```
...
```text
Step 1:ผมได้คิดlogicให้เช็คเป็นสีต่อสีไปเลย
Step 2:ผมได้เจอปัญหาระหว่างทางเลยเพิ่มlogicเข้าไปอีกให้ครบกรณี
Step 3:เเละผมก็ได้ใช้AIช่วยหาtestcaseที่ผมหาไม่เจอเเละก็เขียนcaseนั้นเเละก้เสร็จ
```
...
```เหมือนกันเเค่เพิ่มlogicเพิ่มมาเพื่อให้ครบtestcase

...
```text
https://ijudge.it.kmitl.ac.th/submissions/627179/overview
```
...
Input:
รับstr เข้า เเละ ออก เเละรับfloat

Output:
ราคาพัสดุที่ถ้าไม่อยู่ในตารางให้แสดงข้อความว่า Error)
...
```text
Step 1: เเยกไปกลับ
Step 2: check ว่าไปกลับเป็นcaseไหน
Step 3: คำนวณในcaseนั้น
Step 4: ถ้าไม่อยู่ ในcase ให้ปริ้นerror
```
...
```text
เหมือนกับแผนแรก เเค่เขียนweightผิดไป โดยคิดโดยการหาcaseที่ตรงเเละนำเข้าไปใส่เลยเเละหาค่าออกมา
```

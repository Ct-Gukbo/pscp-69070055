...
```text
https://ijudge.it.kmitl.ac.th/submissions/629367/overview
```
...
```text
อ่านจำนวนเต็ม4ตัว แล้วตัดสินว่าในfunctionนี้print ค่าที่หาจากการหาเหลือเศษ r

Input:
โปรแกรมรับจำนวนเต็มหนึ่งค่า A B d r

Output:
integer ที่เหลือออกจาก

Constraints:
input เป็นจำนวนเต็ม ควรพิจารณา 0 และตัวเลขติดลบด้วย 
```
...
```text
Step 1: อ่านจำนวนเต็ม A B d r
Step 2: เช็คว่าจำนวนนับมากกว่าเศษไหม
Step 3: ถ้าไม่ให้เข้าสมการ
Step 4: print จำนวนนับ B - A
```
...
```text
เหมือนเเต่เเค่เเก้สมการไปเรื่อยๆ
```

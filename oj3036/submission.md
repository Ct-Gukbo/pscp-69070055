...
```text
https://ijudge.it.kmitl.ac.th/submissions/600133/overview
```
...
```text
โจทย์ให้คำนวนจำนวนช่องว่าต้องพังกำเเพงกี่อันถึงจะถึง1
Input:
รับค่าจำนวนหนึ่งค่า n

Output:
ค่าที่พังกำเเพงออกจนมาถึง1

Constraints:
input เป็นจำนวนเต็มที่มากกว่า1 ถ้า 1 ให้ตอบเป็น 0
```
...
Step 2: หาชั้นของตัวเลขนั้นเเละเก็บค่าชั้นเพื่อไปคิด
Step 3: หาว่าชั้นนั้นเป็นคู่หรือคี่
Step 4: หาในชั้นว่าเป็นคู่หรือคี่
Step 5: เอาค่าชั้นไปคิดเป็นคำตอบ
ก่อนถามพี่ TA ผมลืม 1 = 0 
```
...
```text
เพราะมันมากกว่าชั้นที่กำหนดให้
```
